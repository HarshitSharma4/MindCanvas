...
('t0000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'productivity', '#22c55e'),
('t0000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'ai', '#8b5cf6'),
('t0000001-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'learning', '#3b82f6'),
('t0000001-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'personal', '#f59e0b'),
('t0000001-0000-0000-0000-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'health', '#ef4444'),
('t0000001-0000-0000-0000-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'finance', '#10b981');
...
('j0000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
...
('j0000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
...
('j0000001-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
...
('j0000001-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
...
('j0000001-0000-0000-0000-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
...
('j0000001-0000-0000-0000-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
...
('tk000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'p0000001-0000-0000-0000-000000000001',
...
('tk000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'p0000001-0000-0000-0000-000000000001',
 'Build dashboard command center', 'Aggregated stats, greeting, daily motivation', CURRENT_DATE + INTERVAL '3 days', 'high', 'todo'),
('tk000001-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'p0000001-0000-0000-0000-000000000001',
 'Google Calendar OAuth integration', NULL, CURRENT_DATE + INTERVAL '7 days', 'medium', 'todo'),
('tk000001-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', NULL,
 'Call parents this weekend', NULL, CURRENT_DATE + INTERVAL '2 days', 'medium', 'todo'),
('tk000001-0000-0000-0000-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', NULL,
 'Buy running shoes', 'Need new pair for half marathon training', CURRENT_DATE + INTERVAL '5 days', 'low', 'todo'),
('tk000001-0000-0000-0000-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'p0000001-0000-0000-0000-000000000001',
 'Set up CI/CD pipeline', NULL, CURRENT_DATE + INTERVAL '10 days', 'medium', 'todo'),
('tk000001-0000-0000-0000-000000000007', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'p0000001-0000-0000-0000-000000000002',
 'Write article on RAG patterns', NULL, CURRENT_DATE + INTERVAL '7 days', 'medium', 'in_progress'),
('tk000001-0000-0000-0000-000000000008', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', NULL,
...
('l0000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'System Design Masterclass', 'System Design', 30, 'in_progress', 'https://example.com/course'),
('l0000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Advanced Python Async', 'Python', 60, 'in_progress', NULL),
('l0000001-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'RAG & Vector Databases', 'AI', 40, 'in_progress', NULL),
('l0000001-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Advanced TypeScript', 'TypeScript', 80, 'in_progress', NULL);
...
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'l0000001-0000-0000-0000-000000000001', 'Load Balancers & CDNs', 90, CURRENT_DATE),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'l0000001-0000-0000-0000-000000000003', 'pgvector & Semantic Search', 120, CURRENT_DATE - INTERVAL '1 day'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'l0000001-0000-0000-0000-000000000004', 'Discriminated Unions', 60, CURRENT_DATE - INTERVAL '2 days'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'l0000001-0000-0000-0000-000000000002', 'AsyncIO internals', 45, CURRENT_DATE - INTERVAL '3 days'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'l0000001-0000-0000-0000-000000000001', 'Database Sharding', 75, CURRENT_DATE - INTERVAL '4 days'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'l0000001-0000-0000-0000-000000000003', 'RAG Pipeline Architecture', 90, CURRENT_DATE - INTERVAL '5 days'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'l0000001-0000-0000-0000-000000000004', 'Template Literal Types', 40, CURRENT_DATE - INTERVAL '6 days');
